        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><small>Edit Data Pengajuan</small></li>
            </ol>
          </div>
        </div>
            ...
            <div class="card card-gray card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active ml-4" id="custom-tabs-one-perawatan-tab" data-toggle="pill" href="#custom-tabs-one-perawatan" role="tab" aria-controls="custom-tabs-one-perawatan" aria-selected="true"><b>Data Pengajuan</b></a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                   ...
                   <div class="card card-info">
                    ...
                    <div class="card-body">
                      <form class="form-horizontal" action="<?php echo base_url('member/pengajuanEdit/'). $onepengajuan['id_pengajuan'];?>" method="post">
                        ...
                        <input type="hidden" readonly value="<?php echo $onepengajuan['id_pengajuan'];?>" name="zz" class="form-control" >

                        <div class="form-group row ml-2">
                          <label for="addNamaPer" class="col-sm-2 col-form-label">Nama Barang </label>
                          <div class="col-sm-4">
                            <input type="text" name="a" class="form-control" id="addNamaPer" placeholder="Nama Barang" value="<?php echo $onepengajuan['nm_pengajuan'];?>">
                        ...
                        <div class="form-group row ml-2">
                          ...
                          <div class="col-sm-4">
                            <select name="b" id="AddKategoriPer" class="form-control">
                              ...
                              <?php foreach($lokasidata as $lodat) : ?>
                                <?php if($lodat['id_lokasi'] == $onepengajuan['lokasi']) : ?>
                         ...
                         <div class="form-group row ml-2">
                          ...
                          <div class="col-sm-4">
                            <input type="text" name="c" class="form-control" id="addNamaPer" placeholder="Meja Ke /dll" value="<?php echo $onepengajuan['lokasi_rinci'];?>">
                        ...
                        <div class="form-group row ml-2">
                          ...
                          <div class="col-sm-4">
                            <div class="input-group">
                              ...
                              <input type="date" name="d" class="form-control float-right" id="kegiatanAdd" value="<?php echo $onepengajuan['tgl_pengajuan'];?>">
                            </div>
                        ...
                        <div class="form-group row ml-2">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" name="e" id="detailUserSettAddress" rows="3" placeholder="Keterangan.." value="<?php echo $onepengajuan['keterangan'];?>"><?php echo $onepengajuan['keterangan'];?></textarea>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a style="margin-right: 10px" href="#" data-toggle="modal" data-target="#perbaikanDetailModal<?php echo $allper['id_pengajuan'];?>" title="Detail"><i class="fas fa-book-open text-info"></i></a>
                                <a style="margin-right:10px" href="#" data-toggle="modal" data-target="#perbaikanEditModal<?php echo $allper['id_pengajuan'];?>" title="Edit"><i class="fas fa-edit text-secondary"></i></a>
                                <a style="margin-right:10px" href="#" data-toggle="modal" data-target="#perbaikanDeleteModal<?php echo $allper['id_pengajuan'];?>" title="Delete"><i class="fas fa-trash text-danger"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
...
<?php $i=0; foreach($allpengajuan as $allper) : $i++; ?>
<div class="modal fade" id="perbaikanDetailModal<?php echo $allper['id_pengajuan'];?>">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-info">
        <h5 class="modal-title">Detail Perbaikan "<?php echo $onepengajuan['nm_pengajuan'];?>"</h5>
      ...
      <form>
        <div class="modal-body">
          <form class="form-horizontal" action="<?php echo base_url('member/pengajuanAdd')?>" method="post">
            <div class="form-group row">
              <label class="col-sm-4 col-form-label" for="kegiatanAdd">Tanggal Pengajuan</label>
              <div class="col-sm-8">
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                  ...
                  <input type="date" name="e" class="form-control float-right" id="kegiatanAdd" value="<?php echo $allper['tgl_pengajuan'];?>" disabled>
                </div>
                <?php echo form_error('e', '<small class="text-danger pl-3">', '</small>');?>
              </div>
            </div>
...
<?php $i=0; foreach($allpengajuan as $allper) : $i++; ?>
<div class="modal fade" id="perbaikanEditModal<?php echo $allper['id_pengajuan'];?>">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h5 class="modal-title">Pengajuan Data Edit</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?php echo base_url('member/perbaikanEdit/'). $onepengajuan['id_pengajuan'];?>" method="post">
        <div class="modal-body">
          <input type="hidden" name="zz" readonly value="<?php echo $allper['id_pengajuan'];?>"  class="form-control" >
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <input type="date" name="aa" class="form-control float-right" id="kegiatanAdd" value="<?php echo $allper['tgl_pengajuan'];?>">
              </div>
            </div>
          </div>
          <div class="form-group row">
...
<?php $i=0; foreach($allpengajuan as $allper) : $i++; ?>
<div class="modal fade" id="perbaikanDeleteModal<?php echo $allper['id_pengajuan'];?>">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        <h5 class="modal-title">Hapus <?php echo $allper['tgl_pengajuan'];?> </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>Pilih "Hapus" dibawah untuk menghapus Data Tanggal <?php echo $allper['tgl_pengajuan'];?>.</p>
      </div>
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a class="btn btn-danger" href="<?php echo base_url('member/pengajuanDelete/')?><?php echo $allper['id_pengajuan'];?>/<?php echo $allper['id_pengajuan'];?>"><i class="fas fa-trash"></i>&ensp;Hapus</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
