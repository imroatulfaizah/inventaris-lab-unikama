                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-pengajuan" role="tabpanel" aria-labelledby="custom-tabs-one-pengajuan-tab">
                   <div class="card card-info">
                    ...
                    <div class="card-body">
                      <form class="form-horizontal" action="<?php echo base_url('keplab/updateStatus/').$onepengajuan['id_pengajuan'];?>" method="post">
                        <div class="form-group row ml-2" hidden>
                          <label for="addNamaPer" class="col-sm-2 col-form-label">ID </label>
                          <div class="col-sm-4">
                            <input type="text" name="j" class="form-control" id="addNamaPer" placeholder="ID" value="<?php echo $onepengajuan['id_pengajuan'];?>" disabled>
                        ...
                        <div class="form-group row ml-2">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" name="f" id="detailUserSettAddress" rows="3" placeholder="Jumlah.." value="<?php echo $onepengajuan['jumlah'];?>" disabled><?php echo $onepengajuan['jumlah'];?></textarea>
                        ...
                        <div class="form-group row ml-2">
                          ...
                          <div class="col-sm-4">
                            <input type="text" name="h" class="form-control" id="addNamaPer" placeholder="Status" value="<?php echo $onepengajuan['status'];?>" disabled>
                            <?php echo form_error('h', '<small class="text-danger pl-3">', '</small>');?>
                          </div>
                        </div>
                        <?php if($onepengajuan['notelab'] != null) { ?>
                          <div class="form-group row ml-2">
                          <label for="addNamaPer" class="col-sm-2 col-form-label">Alasan Diterima </label>
                          <div class="col-sm-4">
                          <input type="text" name="id_note" class="form-control" id="id_note" placeholder="Alasan diterima" value="<?php echo $onepengajuan['notelab'];?>" disabled>
                        ...
                        <div class="card-footer justify-content-between">
                          <a class="btn btn-info btn-sm" href="<?php echo base_url('keplab/pengajuan');?>">
                            <i class="fas fa-arrow-left"></i>&ensp;Back To Pengajuan List
                          </a>
                          <!-- <a class="btn btn-warning float-right btn-sm" href="<?php echo base_url('keplab/updateStatus/'). $onepengajuan['id_pengajuan'];?>">
                            <i class="fas fa-edit"></i>&ensp;Accepted By Kepala Lab
                          </a> -->
                          <?php if($onepengajuan['status'] == 'Accepted By Kepala Lab'){ ?>
                            <button type="submit" class="btn btn-warning float-right btn-sm" href="<?php echo base_url('keplab/updateStatus/'). $onepengajuan['id_pengajuan'];?> " disabled>
                              <i class="fas fa-edit"></i>&ensp;Accepted By Kepala Lab
                            </button>
                          <?php } else { ?>
                            <button type="submit" class="btn btn-warning float-right btn-sm" href="<?php echo base_url('keplab/updateStatus/'). $onepengajuan['id_pengajuan'];?>" >
                              <i class="fas fa-edit"></i>&ensp;Accepted By Kepala Lab
                            </button>
                          <?php } ?>
                        </div>
